...
Response create_nat_ports_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
Response create_nat_ports_list_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
...
Response delete_nat_ports_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response delete_nat_ports_list_by_id_handler(const char *name, const Key *keys, size_t num_keys);
...
Response read_nat_loglevel_by_id_handler(const char *name, const Key *keys, size_t num_keys);
...
Response read_nat_ports_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_nat_ports_ip_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_nat_ports_list_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_nat_ports_peer_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_nat_ports_status_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_nat_ports_type_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_nat_ports_uuid_by_id_handler(const char *name, const Key *keys, size_t num_keys);
...
Response read_nat_type_by_id_handler(const char *name, const Key *keys, size_t num_keys);
Response read_nat_uuid_by_id_handler(const char *name, const Key *keys, size_t num_keys);
...
Response replace_nat_ports_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
Response replace_nat_ports_list_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
...
Response update_nat_loglevel_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
...
Response update_nat_ports_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
Response update_nat_ports_ip_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
Response update_nat_ports_list_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
Response update_nat_ports_peer_by_id_handler(const char *name, const Key *keys, size_t num_keys, const char *value);
...
Response nat_ports_by_id_help(HelpType type, const char *name, const Key *keys, size_t num_keys);
Response nat_ports_list_by_id_help(HelpType type, const char *name, const Key *keys, size_t num_keys);
