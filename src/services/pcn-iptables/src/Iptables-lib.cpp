...
#define SERVICE_DESCRIPTION "iptables API generated from iptables.yang"
...
module iptables {
  ...
  grouping rule-fields {
    ...
    leaf action {
      ...
      basemodel:cli-example "DROP, ACCEPT, LOG";
    }
  }
  ...
  list chain {
    ...
    leaf name {
      ...
      basemodel:cli-example "INPUT, FORWARD, OUTPUT.";
    }
