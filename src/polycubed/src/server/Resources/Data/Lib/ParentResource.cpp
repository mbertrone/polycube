...
ParentResource::ParentResource(
    ...
    : Body::ParentResource(name, description, cli_example, parent, core,
      ...
      Endpoint::ParentResource(name, description, cli_example,
                               rest_endpoint, parent, core,
                               node_fields, true, false, false, false),
...
ParentResource::ParentResource(
    ...
    bool init_only_config, const PolycubedCore *core,
    const std::vector<Body::JsonNodeField> &node_fields,
    bool container_presence)
    : Body::ParentResource(name, description, cli_example, parent, core,
                           node_fields, configuration, init_only_config,
                           container_presence),
      Endpoint::ParentResource(
          name, description, cli_example, rest_endpoint, parent,
          core, node_fields, configuration, init_only_config, false, false),
      create_handler_{},
      replace_handler_{},
      update_handler_{},
      read_handler_{std::move(read_handler)},
