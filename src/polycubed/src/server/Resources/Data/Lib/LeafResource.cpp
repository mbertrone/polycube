...
LeafResource::LeafResource(
    ...
    : Body::LeafResource(name, description, cli_example, parent, core,
      ...
      Endpoint::LeafResource(name, description, cli_example,
                             rest_endpoint, parent, core, nullptr,
...
LeafResource::LeafResource(
    ...
    : Body::LeafResource(name, description, cli_example, parent, core,
      ...
      Endpoint::LeafResource(
          name, description, cli_example, rest_endpoint, parent,
          core, nullptr, node_fields, true, false, mandatory, type, nullptr),
      read_handler_{std::move(read_handler)},
